...
class CheckoutItemCommandTest {
    ...
    void testForPerformActionForSuccessfulCheckoutOfBook() {
        CheckoutItemCommand checkoutItemCommand = new CheckoutItemCommand(ItemType.BOOK);
        ...
        checkoutItemCommand.performCommand(library, outputDriver, inputDriver, authorizedUsers);
    ...
    void testForPerformActionForSuccessfulCheckoutOfMovie() {
        ...
        OutputDriver outputDriver = mock(OutputDriver.class);
        InputDriver inputDriver = mock(InputDriver.class);
        CheckoutItemCommand checkoutItemCommand = new CheckoutItemCommand(ItemType.MOVIE);
